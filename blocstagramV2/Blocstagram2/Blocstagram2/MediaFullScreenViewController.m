...
- (void)viewDidLoad {
    ...
    [self.shareButton addTarget:self action:@selector(shareDidFire) forControlEvents:UIControlEventTouchUpInside];
    [self.scrollView.superview addSubview:self.shareButton];
...
//lets also make sure the image starts out centered
