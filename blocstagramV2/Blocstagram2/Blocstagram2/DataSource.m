...
#pragma mark - initialization of operation manager:
...
#pragma mark - Absolute path to the user's documents 
...
#pragma mark - access token registration

-(void) registerForAccessTokenNotification {
    [[NSNotificationCenter defaultCenter] addObserverForName:LoginViewControllerDidGetAccessTokenNotification object:nil queue:nil usingBlock:^(NSNotification *note) {
        self.accessToken = note.object; //stores the nsstring containing the access token
...
#pragma mark - request media from instagram
...
#pragma mark - Parse Entire Feed

//this parses the whole feed that we just distributed amongst our different classes
...
//when we recieve a new Media item, we'll want to download the associated image to display it
...
#pragma mark - completion handler for old content/infinite scroll
...
#pragma mark - completion handler for new content
...
#pragma mark - deleting mediaItem
